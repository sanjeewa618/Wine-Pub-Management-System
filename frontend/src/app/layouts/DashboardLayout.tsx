    ...
    <div className="flex h-screen bg-[#0a0a0a] text-slate-100 overflow-hidden">
      ...
      >
        ...
        <div className="p-4 border-b border-[#333]">
          <Link
            to="/"
            className="mb-4 inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#E3C06A] hover:text-white transition-colors"
          >
            <ArrowLeft size={14} />
            Home
          </Link>
          <div className="flex items-center space-x-3">
            <div className="h-10 w-10 rounded-full bg-[#E3C06A] flex items-center justify-center font-bold text-black">
        ...
        <div className="p-4 border-t border-[#333]">
          <button 
            onClick={logout}
            className="flex items-center space-x-3 text-[#E3C06A] hover:bg-[#222] w-full px-4 py-3 rounded-lg transition-colors"
          >
            <LogOut size={18} />
